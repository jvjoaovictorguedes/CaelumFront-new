...
try {
  ...
  console.error(
    "Erro ao distribuir pontos aleatoriamente:",
    error,
  );
...
return ( <div className="grid grid-cols-2 gap-3 rounded-2xl border border-black/10 bg-[#3a2f24] p-5 shadow-lg sm:grid-cols-2">
{ATRIBUTOS.map(({ label, campo }) => ( <div
       key={campo}
       className="bg-[#F3B43F]/50 rounded-lg p-3 flex justify-between items-center"
     > <div> <span className="font-imFeel text-xl mr-2">
{label} </span>
  ...
  <div className="col-span-2 flex flex-col gap-3 rounded-lg bg-[#F3B43F]/50 p-3 sm:col-span-1">
    <div className="flex items-center justify-between">
      <span className="font-imFeel text-xl">
