...
function GuerreiroSilhueta({ stroke }: { stroke: string }) {
  return (
      <img src="/images/guerreiro-personagem-itens.webp" alt="Silhueta do Guerreiro" className="h-full w-full" />
  );
}

function MagoSilhueta({ stroke }: { stroke: string }) {
  return (
    <img src="/images/mago-personagem-itens.webp" alt="Silhueta do Mago" className="h-full w-full" />
  );
}

function CelestialSilhueta({ stroke }: { stroke: string }) {
  return (
    <img src="/images/celestial-personagem-itens.webp" alt="Silhueta do Celestial" className="h-full w-full" />
  );
}

function PrimordialSilhueta({ stroke }: { stroke: string }) {
  return (
    <img src="/images/primordial-personagem-itens.webp" alt="Silhueta do Primordial" className="h-full w-full" />
  );
}
