    ...
    <div className="flex flex-col rounded-2xl border-2 border-[#F3B43F] bg-[#292018]/90 p-5 text-white shadow-xl">
      ...
      <form onSubmit={enviar} className="flex gap-2">
        <input
          ...
          maxLength={500}
          disabled={!conectado}
          className="flex-1 rounded-lg border border-white/20 bg-black/30 px-3 py-2 text-white placeholder-white/40 outline-none focus:border-[#F3B43F] disabled:opacity-50"
        />
        <button
          type="submit"
