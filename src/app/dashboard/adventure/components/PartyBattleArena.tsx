...
export default function PartyBattleArena() {
  ...
  // (não só no mount do componente — diferente de CombatArena.tsx/
  // combate solo, este componente continua montado entre uma batalha em
  // grupo e outra, só alternando o que renderiza; battleId muda a cada
  // batalha nova, então é o gatilho certo pro hook sortear de novo).
  useContextMusic("CONTEXT_COMBAT_PVE", { ativo: !!batalhaGrupo, activationKey: batalhaGrupo?.battleId });
